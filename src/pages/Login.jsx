  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black px-4">
      <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-950 p-6 shadow-2xl shadow-black/30">
        ...
        <p className="mt-1 text-sm text-zinc-400">Sign in to continue to your delegate console.</p>
        ...
        <p className="mt-4 text-sm text-zinc-400">
          New to Loominaries?{' '}
          <Link to="/signup" className="font-semibold text-white underline-offset-2 hover:text-indigo-300 hover:underline">
            Create an account
          </Link>
        </p>
      </div>
